...
export const setPasswordAfterVerification = async (token: string, password: string) => {
  try {
    const response = await api.post('/set-password-after-verification', { token, password })
